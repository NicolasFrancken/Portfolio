  ...
  return (
    <section id="projects" className="Proyects-container">
      ...
      <div className="Proyects-card-container">
        ...
        <div className="proyect-5 proyect-container">
          <div className="left">
            <div className="top">
              <h3 className="proyect-title">Client's Landing Page &#128666;</h3>
              <p className="proyect-description">
                A personalized landing page for a real client.
              </p>
            </div>
            <div className="bottom">
              <h3>Tech used</h3>
          ...
          <div className="right">
            <a
              ...
              rel="noreferrer"
            >
              <div className="img-proyect-5"></div>
            </a>
            <div className="proyect-links">
              <a
              ...
              <a
                href="https://github.com/NicolasFrancken/transporte-multiservicios"
                target="_blank"
                rel="noreferrer"
              >
                <i className="bx bx-sm bxl-github"></i>
